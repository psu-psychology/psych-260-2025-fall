...
::: {.column width=33%}
- No!
- [Santiago Ramon Y Cajal](https://en.wikipedia.org/wiki/Santiago_Ramón_y_Cajal)
...
:::
::: {.column width=50%}
![](https://www.brainfacts.org/-/media/Brainfacts2/In-the-Lab/Tools-and-Techniques/Article-Images/patient-sm-brain-byte.jpg)
:::
::::
