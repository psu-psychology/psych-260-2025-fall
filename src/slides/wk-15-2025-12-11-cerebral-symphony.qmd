...
- Directional terms, slices
    + In the human forebrain `____` and superior are analogous.
- Gross anatomy
...
- Neuromodulators -- DA, NE, 5-HT, factors that distinguish neuromodulators from other NTs
- Hormones
...
- Evidence that serotonin deficits are common in MDD
