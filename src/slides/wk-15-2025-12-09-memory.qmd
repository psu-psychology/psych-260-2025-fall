...
:::
::: {.column width=50%}
![](https://www.researchgate.net/profile/James_Herman3/publication/256074938/figure/fig3/AS:216468764532738@1428621583098/Stress-habituation-and-facilitation-Repeated-exposure-to-the-same-stressor-results-in.png){fig-align="right" width="75%"}
:::
::::
...
:::
::: {.column width=50%}
![](https://fiveable.me/_next/image?url=https%3A%2F%2Fstorage.googleapis.com%2Fstatic.prod.fiveable.me%2Fsearch-images%252F%2522Associative_learning_in_neuroscience%253A_classical_conditioning_and_operant_conditioning_visual_examples_and_diagrams%2522-xovif0rym92iydf2abpg.jpe.jpg&w=3840&q=75)
:::
::::
