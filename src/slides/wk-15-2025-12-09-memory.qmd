...
- It involves a single synapse from stretch receptor to muscle fiber
- It involves multiple synapses from stretch receptors onto cortical neurons
- Only one synapse is needed to activate an entire muscle
- A motor neuron exiting the spinal cord only makes one synapse.
