...
:::: {.columns}
::: {.column width=30%}
![Dopamine projections](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Dopaminergic_pathways.svg/1200px-Dopaminergic_pathways.svg.png)
:::
::: {.column width=5%}
:::
::: {.column width=30%}
![Raphe Nuclei (5-HT)](https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Serotonergic_neurons.svg/1280px-Serotonergic_neurons.svg.png)
:::
::: {.column width=5%}
:::
::: {.column width=30%}
![Locus Coeruleus (NE)](https://upload.wikimedia.org/wikipedia/commons/6/6d/Locus-coeruleus.gif)
:::
::::
...
- Folk psychology memes oversimplify
  - Oxytocin is the "love" hormone
  - Cortisol is the "stress" hormone
- Complex, interacting systems $\rightarrow$ no simple stories
