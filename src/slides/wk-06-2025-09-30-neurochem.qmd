...
- EEG & MEG rely on electromagnetic (electro- magneto-encephalography) signals
- Electromagnetic signals are generated & propagate quickly
- High temporal resolution (>> fMRI)
- Signal sources distributed widely, so low spatial resolution (<< fMRI)
